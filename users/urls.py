...
from .views import redirect_to_stripe_billing_portal # Importer la nouvelle vue
...
urlpatterns = [
    ...
    path('profile/billing/', redirect_to_stripe_billing_portal, name='stripe_billing_portal'),
]